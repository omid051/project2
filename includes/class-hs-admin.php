...
class HS_Admin {
    ...
    public function enqueue_scripts($hook) {
        ...
        wp_enqueue_style('hs-admin-styles', HS_PLUGIN_URL . 'assets/css/admin.css', [], '7.1.0');
        wp_enqueue_script('hs-admin-js', HS_PLUGIN_URL . 'assets/js/admin.js', ['jquery'], '7.1.0', true);
